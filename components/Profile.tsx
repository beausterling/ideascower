      ...
      <div className="relative border border-gray-800 bg-[#080808] overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 p-8 md:p-12">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-serif text-white mb-3 tracking-tight">Profile</h2>
          ...
          <div className="mb-12">
            <h3 className="text-tower-neon font-bold font-mono uppercase text-sm mb-6 tracking-widest flex items-center gap-2">
            ...
            <div className="space-y-6">
              {/* Email Display */}
              <div className="flex items-center gap-4 p-4 bg-black/30 border border-gray-800 rounded-sm">
                ...
                {!isChangingEmail && (
                  <button
                    ...
                    className="text-xs font-mono text-gray-500 hover:text-tower-neon transition-colors uppercase tracking-wider"
                  >
                    Change
                  </button>
                )}
                ...
                <form onSubmit={handleChangeEmail} className="p-4 bg-black/30 border border-gray-800 rounded-sm">
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 bg-black/50 border border-gray-700 rounded-sm px-4 py-2 text-gray-200 font-mono text-sm focus:border-tower-neon focus:outline-none focus:ring-1 focus:ring-tower-neon"
                    />
                    <button
                      type="submit"
                      disabled={emailSaving || !newEmail.trim()}
                      className="px-4 py-2 bg-tower-neon text-black font-mono text-sm uppercase tracking-wider hover:bg-tower-neon/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-2 border border-gray-700 text-gray-400 font-mono text-sm uppercase tracking-wider hover:text-white hover:border-gray-500 transition-colors"
                    >
                      Cancel
                    </button>
                  </div>
                  ...
                  {isEditingName ? (
                    <div className="flex gap-3">
                      <input
                        ...
                        className="flex-1 bg-black/50 border border-gray-700 rounded-sm px-3 py-1 text-gray-200 font-mono text-sm focus:border-tower-neon focus:outline-none focus:ring-1 focus:ring-tower-neon"
                      />
                      <button
                        onClick={handleSaveName}
                        disabled={nameSaving}
                        className="px-3 py-1 bg-tower-neon text-black font-mono text-xs uppercase tracking-wider hover:bg-tower-neon/80 transition-colors disabled:opacity-50"
                      >
                        {nameSaving ? '...' : 'Save'}
                      </button>
                      <button
                        ...
                        className="px-3 py-1 border border-gray-700 text-gray-400 font-mono text-xs uppercase tracking-wider hover:text-white transition-colors"
                      >
                        Cancel
                      </button>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {nameSuccess && <CheckIcon className="w-4 h-4 text-tower-neon" />}
                    </div>
                  )}
                </div>
                {!isEditingName && (
                  <button
                    ...
                    className="text-gray-500 hover:text-tower-neon transition-colors"
                  >
                  ...
                  >
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <div className="text-gray-200 font-mono text-sm truncate">
                          {idea.idea_text}
                        </div>
                      ...
                      <button
                        ...
                        className="p-2 text-gray-600 hover:text-tower-accent transition-colors"
                        title="Delete"
                      >
