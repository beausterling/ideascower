...
// Read the SQL file
const sqlContent = readFileSync('./import-ideas.sql', 'utf-8');
...
// Parse the values (this is a simplified version - assumes the SQL is well-formed)
const ideas = [
  {
    date: '2025-12-13',
    issue_number: 1,
    title: 'NeuroMesh',
    pitch: 'We disrupt the cloud oligopoly by aggregating the idle NPU (Neural Processing Unit) power of global smartphones into a decentralized, consumer-sourced supercomputer. While you sleep, we train LLMs and render complex 3D visualizations, paying out crypto micropayments for your contribution and offering developers compute power at 80% below market rates.',
    fatal_flaw: 'The "Latency-Thermal" Death Spiral: High-end applications require low-latency, all-or-nothing blocks of compute power that home devices cannot provide, negating the network\'s appeal. Training jobs could crash mid-session, consumer phones will melt trying to process jobs—processing a $1,000 lithium battery via heat stress nearly exceeds the function of a coal-fire power plant, and unstable latency for the "buyer."',
    verdict: 'A distributed way to destroy lithium-ion batteries while pretending to be a data center.'
  },
  {
    date: '2025-12-14',
    issue_number: 2,
...
console.log(`✅ Successfully imported ${ideas.length} ideas!`);
